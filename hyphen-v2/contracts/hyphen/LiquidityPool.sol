...
// This contract holds all of the liquidity for all supported tokens.
// This contract provides methods to:
//       1. deposit funds in source chain's pool and withdraw funds from the source chain's pool.
...
contract LiquidityPool is ReentrancyGuardUpgradeable, Pausable, OwnableUpgradeable, ERC2771ContextUpgradeable {
    ...
    function depositNative(
        ...
        // Step 5
        if (rewardAmount != 0) { // there is no reason to have this if statement because there is no impact here if the rewardAmount was 0.
