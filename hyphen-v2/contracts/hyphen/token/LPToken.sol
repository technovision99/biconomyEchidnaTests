...
import "./Base64.sol/contracts/base64.sol";
...
// An ERC-721 token that represents liquidity provided by an liquidity provider for a given token pool.
//
// Whenever a liquidity provider supplied liquidity for a given token, a NFT is minted for that liquidity provider.
// Whoever owns the NFT has the rights to claim the liquidity and any associated rewards from the pool.
